...
<main class="form-signin w-100 m-auto">
	<form method="post">
		<div class="btn-group d-flex mb-3" role="group">
			...
			<input type="radio" class="btn-check" name="identityType" id="Guru" value="Guru" bind:group={identityType} on:change={onIdentityChange} />
		...
		<FormInput name="id" type="text" displayName={identityType == 'Guru' ? 'NIK' : 'NIS'} maxlength={8} />
		...
		{#if type == 'register'}
			<FormInput name="confirmPassword" type="password" displayName="Konfirmasi Password" />
		{/if}
