...
<div class="box bg-white shadow">
	<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#siswaModal" on:click={() => addSiswa()}>
		...
		<table class="table">
			...
			<tbody>
				{#each daftarSiswa as siswa, i}
					<tr>
						<td>
							<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#siswaModal" on:click={() => editSiswa(i)}>
			...
			<form method="post" action="?/upsert">
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="nama" name="nama" bind:value={currentSiswa.nama} on:input={() => onFormInput()} required />
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<select class="form-select" id="jenisKelamin" name="jenisKelamin" bind:value={currentSiswa.jenisKelamin} on:change={() => onFormInput()}>
					...
					<div class="mb-3">
						...
						<select class="form-select" id="agama" name="agama" bind:value={currentSiswa.agama} on:change={() => onFormInput()}>
...
>
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				Apakah Anda yakin untuk menghapus {currentSiswa.nama}?<br /><b>NB: User yang terasosiasi akan juga dihapus.</b>
			</div>
			<div class="modal-footer">
